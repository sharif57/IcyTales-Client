    ...
    return <div className="mt-16">
        ...
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-4 mt-14">
            <div className="relative">
                ...
                <div className="flex items-center gap-8 bg-white p-4 absolute bottom-4 left-4  rounded-lg">
            ...
            <div className="relative">
                ...
                <div className="flex items-center gap-8 bg-white p-4 absolute bottom-4 left-4  rounded-lg jub">
